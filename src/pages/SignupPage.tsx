...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex items-center justify-center p-6 relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-900 via-black to-black">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            <img src="/logo.png" alt="Spendwise" className="w-10 h-10 rounded-xl object-cover shadow-md shadow-emerald-500/20 ring-1 ring-zinc-800" />
            <span className="text-2xl font-bold tracking-tight text-white">SpendWise</span>
          </Link>
          <h1 className="text-3xl font-bold text-white mb-2">Create an account</h1>
          <p className="text-zinc-400">Start managing your finances better today</p>
        </div>

        <div className="bg-zinc-950/90 backdrop-blur-xl p-8 rounded-3xl border border-zinc-800/80 shadow-2xl shadow-black">
          {error && (
            <div className="mb-6 p-4 bg-red-950/40 border border-red-800/50 rounded-2xl flex items-start gap-3 text-red-400 text-sm animate-in fade-in slide-in-from-top-2">
              <AlertCircle className="shrink-0 mt-0.5" size={18} />
              <div className="flex-1 font-medium">
                {error}
                {error.includes('already exists') && (
                  <div className="mt-1 font-normal">
                    <Link to="/login" className="underline font-semibold hover:text-red-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-xl py-3 pl-10 pr-4 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 outline-none transition-all text-zinc-100 placeholder-zinc-500 focus:bg-zinc-900/90"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-xl py-3 pl-10 pr-12 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 outline-none transition-all text-zinc-100 placeholder-zinc-500 focus:bg-zinc-900/90"
                />
                <button
                  type="button"
            ...
            <button type="submit" className="w-full bg-emerald-500 text-zinc-950 hover:bg-emerald-400 py-3 rounded-xl font-bold transition-all shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2 mt-4">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-zinc-950 text-zinc-400">Or sign up with</span>
            </div>
          </div>
